<div class="max-w-2xl mx-auto mt-10 bg-white p-8 rounded-3xl shadow-lg border-2 border-[#091235] space-y-8">
    ...
    <div class="text-center border-b-4 border-green-400 pb-4">
        ...
        <p class="text-gray-600 mt-2">Fill in the details below to list your product</p>
    </div>
    ...
    <div class="border-t-4 border-blue-400 pt-8 mt-8">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">📦 Products in Catalog</h2>
        ...
        <div class="row g-3">
            ...
            @empty
                <div class="col-12">
                    <p class="text-center text-gray-500 text-lg">📭 No products in catalog yet.</p>
                </div>
            @endforelse
        </div>
